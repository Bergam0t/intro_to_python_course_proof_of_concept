...
Notice that I surrounded the word **dog** with quotation marks. This is so Python doesn't start trying to work out what 'dog' is - instead it just recognises that it is a **string** - basically just a bit of text! 
